...
/*
 * ORIGINAL AND DEVELOPED BY DEXF TEAM AND DEMON
...
contract TestERC20 is  IERC20, Ownable {
    ...
    string private _name = "Eris Galaxy";
    string private _symbol = "CAOS";
    ...
    uint256 internal _tokenTotal = 60000000 *10**18; 
    ...
    uint16 private tradeCooldown = 59;
    uint public _devFee = 100;  // 100 = 1%, 
    uint public _burnFee = 100; // 100 = 1%, 
    
    uint public _devFeeTotal; //dev
    uint public _burnFeeTotal; //burn fee
    
    address public devAddress = 0x5B4969d1aD37F5264DF41241DA6FB2C70941B9e3; // Dev Address
    address public burnAddress = 0x000000000000000000000000000000000000dEaD; // Burn Address

    event changeCooldown(uint16 tradeCooldown);
   ...
   function setCooldownForTrades(uint16 _tradeCooldown) external onlyOwner {
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        if(!isExcludedFromFee[sender] && !isExcludedFromFee[recipient]){
            amount = collectFee(sender,amount,rate);
    ...
    function collectFee(address account, uint amount, uint256 rate) private returns (uint256) {
    ...
    function set4thFee(uint184 fee) public onlyOwner {
        _burnFee = fee;
    }

    
    function _initialTransfer() private{
        transfer( 0xC3f9b809c6AF1E643e006D958DF011D6Be7EC260, 600000 *10**18); // EQUIPO
        transfer( 0x4C43CC680F5d4d169d1102c289822eB6Acf1Be04, 6000000 *10**18); // FONDE DE RESERVA
        transfer( 0xaA2eBC18787dC798df27C67665eA1a892D8b5686, 1800000 *10**18); // MARKETING
        transfer( 0xe8F43720aC0AabaD73E19a5d1F84581e0F2dC307, 13200000 *10**18); // STALKING
        transfer( 0x5743AcF0EB673E7D150003291F923173617dc364, 31500000 *10**18); // GANANCIA DEL JUEGO
    }
